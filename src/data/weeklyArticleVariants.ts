...
const KEYWORD_IMAGES: Array<{ when: RegExp; ids: LevelIds }> = [
  // 정치
  { when: /(투표|선거|민주주의|공약|후보|유권자)/, ids: { elementary: '1540910419892-4a36d2c3266c', middle: '1726499637922-9f544cbc0fd2', high: '1517245385427-6c4a9e64a108' } },
  { when: /(국회|입법|정국|여야|법안)/, ids: { elementary: '1540910419892-4a36d2c3266c', middle: '1517245385427-6c4a9e64a108', high: '1524661135-423995f22d0b' } },
  { when: /(태극기|국기|3·1|독립|독립운동|애국가)/, ids: { elementary: '1540914122471-2b16eae459de', middle: '1528360983277-518d751faf61', high: '1523050854058-24b38136d167' } },
  { when: /(남북|한반도|평화|국방|병역|군)/, ids: { elementary: '1524661135-423995f22d0b', middle: '1540914122471-2b16eae459de', high: '1473341304177-3d6342c5b8c6' } },
  { when: /(역사 인식|역사 교과서|역사 논의)/, ids: { elementary: '1540914122471-2b16eae459de', middle: '1523050854058-24b38136d167', high: '1579621970563-ebec7560ff3e' } },
  // 경제
  { when: /(전기요금|전기료|가스 요금|에너지 가격|난방)/, ids: { elementary: '1473341304177-3d6342c5b8c6', middle: '1559757148-5c4a2c950330', high: '1509391366360-2e77ee52d5d2' } },
  { when: /(돈|용돈|저축|월급|봉급|세뱃돈|물건을 사요)/, ids: { elementary: '1553729459-0feda8a5386f', middle: '1560518883-ce09059e6725', high: '1611972616597-649dce757427' } },
  { when: /(경제|물가|인플레이션|공급망|수출|경상수지)/, ids: { elementary: '1579621970563-ebec7560ff3e', middle: '1553729459-0feda8a5386f', high: '1568967729541-096375bef6e8' } },
  { when: /(환율|원화|달러|엔|환전)/, ids: { elementary: '1611972616597-649dce757427', middle: '1579621970563-ebec7560ff3e', high: '1521737715017-d6805ec7ed54' } },
  { when: /(금리|전세|매매|주택)/, ids: { elementary: '1560518883-ce09059e6725', middle: '1553729459-0feda8a5386f', high: '1473341304177-3d6342c5b8c6' } },
  { when: /(구직|취업|일자리|최저임금|아르바이트)/, ids: { elementary: '1521737715017-d6805ec7ed54', middle: '1434030216841-604d0b114f72', high: '1503676260728-1c00da094a0b' } },
  { when: /(바이오|헬스케어|신약|진단)/, ids: { elementary: '1576092764391-3510ef7972a3', middle: '1544367567-0f2fcb009e0b', high: '1584305567982-91ec7c132d2f' } },
  { when: /(반도체|수출 규제|미중)/, ids: { elementary: '1568967729541-096375bef6e8', middle: '1676299082083-2dc7f3d440b4', high: '1593941707882-6fc9552d0e76' } },
  // 사회
  { when: /(귀성|교통|고속도로|KTX|버스|수송)/, ids: { elementary: '1544620347-c4fe4d3a4d59', middle: '1529156069898-49953e39b3ac', high: '1600887012170-422167697c84' } },
  { when: /(친구|도와|반에서|다문화|공동체|서로)/, ids: { elementary: '1529156069898-49953e39b3ac', middle: '1523050854058-24b38136d167', high: '1517245385427-6c4a9e64a108' } },
  { when: /(가족|할머니|이웃|명절)/, ids: { elementary: '1529156069898-49953e39b3ac', middle: '1528360983277-518d751faf61', high: '1544620347-c4fe4d3a4d59' } },
  { when: /(저출산|고령화|노인|시니어|실버)/, ids: { elementary: '1600887012170-422167697c84', middle: '1529156069898-49953e39b3ac', high: '1544367567-0f2fcb009e0b' } },
  { when: /(학교폭력|상담|법적 대응|갈등)/, ids: { elementary: '1523050854058-24b38136d167', middle: '1589829545856-d10d557cf95f', high: '1517245385427-6c4a9e64a108' } },
  { when: /(촛불|집회|시민 참여)/, ids: { elementary: '1517245385427-6c4a9e64a108', middle: '1540910419892-4a36d2c3266c', high: '1524661135-423995f22d0b' } },
  { when: /(교통 안전|안전사고|재난|지진|화재)/, ids: { elementary: '1544620347-c4fe4d3a4d59', middle: '1534368959575-1927319b2c05', high: '1584305567982-91ec7c132d2f' } },
  // 문화
  { when: /(설날|명절|윷놀이|제기차기|비석치기|세배)/, ids: { elementary: '1528360983277-518d751faf61', middle: '1513546483692-cb967e75eb7a', high: '1493225457124-ccbcddeba207' } },
  { when: /(발렌타인|초콜릿|사랑 나눠요)/, ids: { elementary: '1513546483692-cb967e75eb7a', middle: '1523241287236-6470d976904f', high: '1611162616475-46b6352e64ce' } },
  { when: /(한복|전통 놀이|판소리|전통음악)/, ids: { elementary: '1528360983277-518d751faf61', middle: '1523241287236-6470d976904f', high: '1511671782779-c97d3d27a1d4' } },
  { when: /(K팝|한류|드라마|웹툰|웹소설|K콘텐츠|콘텐츠)/, ids: { elementary: '1493225457124-ccbcddeba207', middle: '1611162616475-46b6352e64ce', high: '1523241287236-6470d976904f' } },
  { when: /(봄꽃|벚꽃|진달래|꽃이 피어요|등산|캠핑|아웃도어)/, ids: { elementary: '1523241287236-6470d976904f', middle: '1490750967868-88aa4986a51c', high: '1491002054626-602b485f489f' } },
  { when: /(OTT|넷플릭스|웨이브|스트리밍|미디어 산업)/, ids: { elementary: '1611162616475-46b6352e64ce', middle: '1493225457124-ccbcddeba207', high: '1507003211169-0a1dd7228f2d' } },
  { when: /(저작권|알고리즘|뉴스 추천|SNS)/, ids: { elementary: '1611162616475-46b6352e64ce', middle: '1676299082083-2dc7f3d440b4', high: '1568967729541-096375bef6e8' } },
  // 과학
  { when: /(태양|해가|달|위상|삭|망)/, ids: { elementary: '1507003211169-0a1dd7228f2d', middle: '1451187580459-43490279c0e6', high: '1581092160569-d6d2e7635a44' } },
  { when: /(우주|로켓|탐사|누리호|스페이스X|스타링크)/, ids: { elementary: '1451187580459-43490279c0e6', middle: '1507003211169-0a1dd7228f2d', high: '1676299082083-2dc7f3d440b4' } },
  { when: /(AI|인공지능|챗봇|딥페이크|가짜 뉴스)/, ids: { elementary: '1676299082083-2dc7f3d440b4', middle: '1503676260728-1c00da094a0b', high: '1568967729541-096375bef6e8' } },
  { when: /(CRISPR|유전자|양자컴퓨터)/, ids: { elementary: '1676299082083-2dc7f3d440b4', middle: '1576092764391-3510ef7972a3', high: '1451187580459-43490279c0e6' } },
  { when: /(전기차|배터리)/, ids: { elementary: '1593941707882-6fc9552d0e76', middle: '1559757148-5c4a2c950330', high: '1509391366360-2e77ee52d5d2' } },
  { when: /(수소|청색수소)/, ids: { elementary: '1559757148-5c4a2c950330', middle: '1593941707882-6fc9552d0e76', high: '1473341304177-3d6342c5b8c6' } },
  { when: /(눈이 오는|한파|겨울|기후변화)/, ids: { elementary: '1491002054626-602b485f489f', middle: '1542601906990-b4d3fb778b09', high: '1509391366360-2e77ee52d5d2' } },
  { when: /(봄이 오면|꽃이 피어요|계절|식물)/, ids: { elementary: '1490750967868-88aa4986a51c', middle: '1523241287236-6470d976904f', high: '1532992742220-6ac5bc4d8b62' } },
  { when: /(비눗방울|과학실험)/, ids: { elementary: '1581092160569-d6d2e7635a44', middle: '1507003211169-0a1dd7228f2d', high: '1576092764391-3510ef7972a3' } },
  // 교육
  { when: /(개학|새 학기|교실|학교|방학)/, ids: { elementary: '1523050854058-24b38136d167', middle: '1503676260728-1c00da094a0b', high: '1434030216841-604d0b114f72' } },
  { when: /(입시|수시|정시|수능|시험|수험생|등록금|장학)/, ids: { elementary: '1434030216841-604d0b114f72', middle: '1523050854058-24b38136d167', high: '1579621970563-ebec7560ff3e' } },
  { when: /(디지털 교육|태블릿|학습부진|멘토링|학점제|진로)/, ids: { elementary: '1503676260728-1c00da094a0b', middle: '1676299082083-2dc7f3d440b4', high: '1611162616475-46b6352e64ce' } },
  { when: /(교육정책|대입|사교육)/, ids: { elementary: '1434030216841-604d0b114f72', middle: '1589829545856-d10d557cf95f', high: '1521737715017-d6805ec7ed54' } },
  { when: /(인권|교권|학생 인권)/, ids: { elementary: '1523050854058-24b38136d167', middle: '1517245385427-6c4a9e64a108', high: '1589829545856-d10d557cf95f' } },
  // 환경
  { when: /(미세먼지|대기질|마스크)/, ids: { elementary: '1584305567982-91ec7c132d2f', middle: '1532992742220-6ac5bc4d8b62', high: '1542601906990-b4d3fb778b09' } },
  { when: /(재생에너지|태양광|풍력|넷제로|기후 위기)/, ids: { elementary: '1509391366360-2e77ee52d5d2', middle: '1559757148-5c4a2c950330', high: '1534368959575-1927319b2c05' } },
  { when: /(플라스틱|바다|재활용|분리수거|탄소)/, ids: { elementary: '1532992742220-6ac5bc4d8b62', middle: '1584305567982-91ec7c132d2f', high: '1509391366360-2e77ee52d5d2' } },
  { when: /(산불|예방)/, ids: { elementary: '1534368959575-1927319b2c05', middle: '1542601906990-b4d3fb778b09', high: '1491002054626-602b485f489f' } },
  { when: /(난방|탄소 배출|환경 오염)/, ids: { elementary: '1542601906990-b4d3fb778b09', middle: '1473341304177-3d6342c5b8c6', high: '1532992742220-6ac5bc4d8b62' } },
  // 국제
  { when: /(해외 여행|동남아|일본)/, ids: { elementary: '1524661135-423995f22d0b', middle: '1544620347-c4fe4d3a4d59', high: '1473341304177-3d6342c5b8c6' } },
  { when: /(UN|세계 평화|국제기구)/, ids: { elementary: '1524661135-423995f22d0b', middle: '1540914122471-2b16eae459de', high: '1517245385427-6c4a9e64a108' } },
  { when: /(동아시아|한미일|정상회담|외교)/, ids: { elementary: '1524661135-423995f22d0b', middle: '1540910419892-4a36d2c3266c', high: '1579621970563-ebec7560ff3e' } },
  { when: /(우크라이나|재건|FTA|G20|국제회의)/, ids: { elementary: '1473341304177-3d6342c5b8c6', middle: '1524661135-423995f22d0b', high: '1560518883-ce09059e6725' } },
  { when: /(유럽|에너지 위기|가스|전력)/, ids: { elementary: '1473341304177-3d6342c5b8c6', middle: '1559757148-5c4a2c950330', high: '1509391366360-2e77ee52d5d2' } },
  // 법·건강·스포츠
  { when: /(명절 사고|법적 책임|교통·음주)/, ids: { elementary: '1589829545856-d10d557cf95f', middle: '1544367567-0f2fcb009e0b', high: '1523050854058-24b38136d167' } },
  { when: /(소년법|아동권리|보호법|개인정보|표현|혐오)/, ids: { elementary: '1589829545856-d10d557cf95f', middle: '1517245385427-6c4a9e64a108', high: '1611162616475-46b6352e64ce' } },
  { when: /(설 음식|소화기|과식|명절 건강)/, ids: { elementary: '1544367567-0f2fcb009e0b', middle: '1584305567982-91ec7c132d2f', high: '1576092764391-3510ef7972a3' } },
  { when: /(정신건강|우울|불안|수면|운동 부족|알레르기|꽃가루)/, ids: { elementary: '1544367567-0f2fcb009e0b', middle: '1523241287236-6470d976904f', high: '1600887012170-422167697c84' } },
  { when: /(동계|스키|스케이팅)/, ids: { elementary: '1551522435-a89afa12578c', middle: '1491002054626-602b485f489f', high: '1546519638-af2f498e742f' } },
  { when: /(야구|KBO|개막)/, ids: { elementary: '1574629810360-7efbe195a735', middle: '1542751371-adc38448a05e', high: '1551522435-a89afa12578c' } },
  { when: /(축구|K리그|유럽 리그)/, ids: { elementary: '1542751371-adc38448a05e', middle: '1546519638-af2f498e742f', high: '1574629810360-7efbe195a735' } },
  { when: /(농구|배구|KBL|V리그|플레이오프)/, ids: { elementary: '1546519638-af2f498e742f', middle: '1542751371-adc38448a05e', high: '1551522435-a89afa12578c' } },
  { when: /(e스포츠|게임)/, ids: { elementary: '1542751371-adc38448a05e', middle: '1568967729541-096375bef6e8', high: '1676299082083-2dc7f3d440b4' } },
  { when: /(문화예술|공영|방송)/, ids: { elementary: '1511671782779-c97d3d27a1d4', middle: '1493225457124-ccbcddeba207', high: '1528360983277-518d751faf61' } },
];
